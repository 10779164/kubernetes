...
if [ ! -f /var/www/html/.installed_magento ]; then
    ...
    sed -i '1c memory_limit = 2G' /data/magento/.user.ini
    sed -i '1c memory_limit = 2G' /data/magento/pub/.user.ini 
    sed -i '1c memory_limit = 2G' /data/magento/vendor/magento/magento2-base/.user.ini
    sed -i '1c memory_limit = 2G' /data/magento/vendor/magento/magento2-base/pub/.user.ini
...
--use-rewrites=1
    ...
    gosu www-data touch /var/www/html/.installed_magento 
fi
